...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
        <form role="form" method="post" action="sales_invoice_bill.php">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <div class="form-group col-sm-4">
                  <label for="Branch">Bill NO</label>
				  
                  <select class="form-control " name="po_no" id="po_no" style="width: 100%;" onkeypress="return tabE(this,event)">
				  
				  <?php
				  $sql="select * from invoice where branch='".$_SESSION['branch']."'order by id desc";
