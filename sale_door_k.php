...
<div class="wrapper">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Door Delivery</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <div class="form-group col-sm-3">
                  ...
                  <input type="text" class="form-control" name="p_invoice" id="p_invoice" value="<?php echo $pno; ?>" placeholder="Purchase Id"  required="true">
                </div>
				<div class="form-group col-sm-3">
                  <label for="Branch">Date</label>
                  <input type="date" class="form-control" name="date" id="date" value="<?php echo $Fsn['pdate']; ?>"  placeholder="Purchase Date" onKeyPress="return tabE(this,event)">
                </div>
				<div class="form-group col-sm-3">
                  <label for="Branch">Customer Name</label>
					<input type="text" class="form-control" name="cname" id="cname" onChange="getrate(this.value)" required="true">
				  </div>
				  				<div class="form-group col-sm-3">
                  <label for="Branch">Customer Mobile</label>
					<input type="text" class="form-control" name="cmobile" id="cmobile"   placeholder="Customer Mobile "  onKeyPress="return tabE(this,event)"  
  onChange="getrate(this.value)">
                ...
                <div class="form-group col-sm-4">
				 ...
				 <input name="txtsearchname" type="text" id="txtsearchname" class="form-control" onkeyup="ajax_showOptions(this,'getCountriesByLetters',event);get_item_name()" onBlur="getFocus();" value="" autocomplete="off" />
				  </div>
				<div class="form-group col-sm-2">
                  <label for="refnumber">MRP</label>
                  <input type="text" class="form-control" name="mrp" id="mrp"  placeholder="MRP" onChange="" readonly="true" >
                </div>
                <div class="form-group col-sm-2">
...
<div class="col-md-12">
          ...
          <!-- /.box -->
                ...
                <a href="purchase_act.php" onClick="return confirm('Are you sure you want to Remove?');" class="btn btn-info pull-right" >Complete</a>
                </div>    
                </div>
