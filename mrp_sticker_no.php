...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
        <form role="form" method="post" action="mrp_sticker_entry_act.php">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <div class="form-group col-sm-4">
                  ...
                  <select class="form-control " name="sticker" style="width: 100%;" onkeypress="return tabE(this,event)">
				  
				  <?php
				  $sql="select * from t_sales_invoice where company='".$_SESSION['company']."'";
...
<div class="col-md-12">
          ...
          <!-- /.box -->
                ...
                <button type="submit" class="btn btn-info pull-right" onClick="return confirm('Are you sure? You want to print sticker for this invoice');">Submit</button>
                </div>    
                </div>
    </form>
    </section>
