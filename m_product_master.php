      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="box box-info">
            ...
            <form class="form-horizontal" method="post" action="m_product_master_act.php">
              <div class="box-body">
                  
                <div class="form-group">
                  <label for="depcode" class="col-sm-3 control-label">Product Id</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="product_id" id="product_id"  onKeyPress="return tabE(this,event)"  placeholder="Barcode" required>
                  </div>
                </div>
                <div class="form-group">
                      <label for="department" class="col-sm-3 control-label">Category</label>
                      <div class="col-sm-4">
                        <select class="form-control" name="category" id="category" onKeyPress="return tabE(this,event)"  placeholder="Department" required>
					 ...
					 <div class="form-group">
                      <label for="department" class="col-sm-3 control-label">Brand</label>
                      <div class="col-sm-4">
                        <select class="form-control" name="brand" id="brand" onKeyPress="return tabE(this,event)"  placeholder="Department" required>
						<option value="">Select Category</option>
						<?php
						$dep1="select brand_name from m_brand_master";
						$dep=mysql_query($dep1);
						while($result=mysql_fetch_array($dep))
						{
						?>
					  ...
					  <a href="m_brand_master.php">Add New Brand</a>
                    </div>   
					 <div class="form-group">
                      <label for="depname" class="col-sm-3 control-label">Description</label>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="description" id="description" onKeyPress="return tabE(this,event)"  placeholder="Description" required>
                      </div>
                    </div>
					 <div class="form-group">
                      <label for="depname" class="col-sm-3 control-label">Product Name</label>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="product_name" id="product_name" onKeyPress="return tabE(this,event)"  placeholder="Item Name" required>
                      </div>
                    </div>
					 <div class="form-group">
					  ...
					  <div class="form-group">
                      <label for="department" class="col-sm-3 control-label">Tax</label>
                      <div class="col-sm-4">
                        <select class="form-control" name="tax" id="tax" onKeyPress="return tabE(this,event)"  placeholder="Department" >
						<option>Select Unit</option>
						<?php
						$dep1="select tax_name from m_tax_master";
						$dep=mysql_query($dep1);
						while($result=mysql_fetch_array($dep))
						{
						?>
						<option value="<?php echo $result['tax_name'];?>"><?php echo $result['tax_name'];?></option>
						<?php
						}
						?>
						</select>
                      </div>
					  <a href="m_tax_master.php">Add New Tax</a>
                    </div>
					 <div class="form-group">
                      <label for="depname" class="col-sm-3 control-label">HSN Code</label>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="hsn_code" id="hsn_code" onKeyPress="return tabE(this,event)"  placeholder="HSN Code" required>
                      </div>
                    </div>
