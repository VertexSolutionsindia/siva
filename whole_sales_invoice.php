...
function get_total(){ 
	 ...
	 var pr = 0;
	 var fpr = 0;
    var inputs = document.getElementById('ws_qty').value;
	var inputs1 = document.getElementById('mrp').value;
	var inputs2 = document.getElementById('ws_discount').value;
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
   ...
   ?>
   <?php
   $sn="select * from ws_invoice_temp";
   $Esn=mysql_query($sn);
   $Fsn=mysql_fetch_array($Esn);
   ?>
    <!-- Main content -->
    <section class="content container-fluid">
        <form role="form" method="post" action="whole_sales_invoice_act.php">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Create  Whole sales Invoice</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <div class="form-group col-sm-3">
                  ...
                  <input type="text" class="form-control" name="ws_ino" id="ws_ino" value="<?php echo $wsno; ?>" placeholder="Purchase Id" onKeyPress="return tabE(this,event)"  required="true">
                </div>
				<div class="form-group col-sm-3">
                  <label for="Branch">Date</label>
                  <input type="text" class="form-control" name="ws_sdate" id="ws_sdate" value="<?php echo date("Y-m-d") ?>"  placeholder="Purchase Date" value="<?php echo $date; ?>" onKeyPress="return tabE(this,event)">
                </div>
				<div class="form-group col-sm-3">
                  <label for="Branch">Customer Name</label>
					<input type="text" class="form-control" name="ws_cname" id="ws_cname" value="<?php echo $Fsn['ws_cname']; ?>" onChange="getrate(this.value)" nKeyPress="return tabE(this,event)" required="true" style="text-transform:uppercase">
				  </div>
				  				<div class="form-group col-sm-3">
                  <label for="Branch">Customer Mobile</label>
					<input type="text" class="form-control" name="ws_cmobile" id="ws_cmobile" value="<?php echo $Fsn['ws_cmobile']; ?>"   placeholder="Customer Mobile "  onKeyPress="return tabE(this,event)"  onChange="getrate(this.value)">
				  </div>
				...
				<div class="form-group col-sm-2">
                  ...
                  <input type="text" class="form-control" name="ws_mrp" id="mrp"  placeholder="MRP" onChange="" onKeyPress="return tabE(this,event)" readonly="true" >
                </div>
                <div class="form-group col-sm-2">
                  <label for="ponumber">Quantity</label>
                  <input type="text" class="form-control" name="ws_qty" id="ws_qty"  placeholder="Quantity" onKeyUp="get_total()" onKeyPress="return tabE(this,event)" >
                </div>
                
				 <div class="form-group col-sm-2">
                  <label for="refnumber">Discount%</label>
                  <input type="text" class="form-control" name="ws_discount" id="ws_discount"  placeholder="Discount" onKeyUp="get_total()" onKeyPress="return tabE(this,event)">
                </div>
				<div class="form-group col-sm-2">
                  <label for="refnumber">Total</label>
                  <input type="text" class="form-control" name="ws_total" id="total"  placeholder="Total" readonly="true" onKeyPress="return tabE(this,event)">
                </div>
          ...
          <div class="box box-danger">
            ...
            <div class="box-body no-padding">
              <table class="table table-bordered padding-4 ">
				...
				<?php
				$i=0;
				$tmp="select * from ws_invoice_temp ";
                ...
                <tr>
                  ...
                  <td><?php echo $Ftmp['ws_iname']; ?></td>
                  <td><?php echo $Ftmp['ws_qty']; ?></td>
                  <td><?php echo $Ftmp['ws_mrp']; ?></td>
				  <td><?php echo $Ftmp['ws_discount']; ?></td>
                  <td><?php echo $Ftmp['ws_total']; ?></td>
