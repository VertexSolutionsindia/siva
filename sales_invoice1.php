...
var per_pack = document.getElementById('per_pack'+$i+'').value;
var quantity = document.getElementById('quantity'+$i+'').value;
var desc=document.getElementById('quantity'+$i+'').value;
if(desc=='')
{
	document.getElementById('priceper'+$i+'').value = 0;
	document.getElementById('per_pack'+$i+'').value = 0;
...
function getNetTotal()
{
	...
	var grandTotal = document.getElementById("net_amount");
  
  // grandTotal.value += parseInt(total);
   var tot=0;
   for(var i=0;i<150;i++)>
   {
	    var iprice = document.getElementById('subtotal'+$i+'');
		if(parseInt(iprice.value))
			tot +=parseInt(iprice.value);	
   }
...
function validateForm() {
    var x = document.forms["salei"]["net_amount"].value;
    if (x == "") {
            return false;
    }
}
 ...
 function sumCost() {
        ...
        var tot = 0;
        for(var i=0; i<5;i++){
			arr = document.getElementById('subtotal'+$i+'');
            if(parseInt(arr.value))
                tot += parseInt(arr.value);
        }
        document.getElementById('net_amount').value = tot;
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <div class="form-group col-sm-4">
                  ...
                  <input type="text" class="form-control" name="invoice_no"  placeholder="invoice_no" value="<?php echo $dc; ?>" onKeyPress="return tabE1(this,event)" readonly="true">
                </div>
            ...
            <div class="box-body no-padding">
              <table class="table table-bordered padding-4 disp">
                ...
                <tr>
                 ...
                 <td><input type="text" name="<?php echo "description".$i; ?>" id="<?php echo "description".$i; ?>" size="15" maxlength="70" value="" onKeyUp="get_mrp(<?php echo $i; ?>);get_item(<?php echo $i; ?>);getQuantity(<?php echo $i; ?>);getTotal(<?php echo $i; ?>);" class="form-control" style="display:visible" /></td>
<td><input type="text" name="<?php echo "priceper".$i; ?>" id="<?php echo "priceper".$i; ?>" size="65"  value=""   class="form-control" readonly="true" style="display:visible" /></td>
<td><input type="text" name="<?php echo "per_pack".$i; ?>" id="<?php echo "per_pack".$i; ?>" size="10" maxlength="9" value="" onBlur="getFocus(<?php echo $i; ?>);" class="form-control" readonly="true" style="display:visible" /></td>
<td><input type="text" name="<?php echo "quantity".$i; ?>" id="<?php echo "quantity".$i; ?>" size="10" maxlength="9" onChange="getTotal(<?php echo $i; ?>);" onBlur="getFocus1(<?php echo $i+1; ?>);sumCost();" class="form-control" style="display:visible" /></td>
<td><input type="text" name="<?php echo "subtotal".$i; ?>" id="<?php echo "subtotal".$i; ?>" size="15" maxlength="9" value="" onChange="sumCost();" class="form-control" readonly="true" style="display:visible" /></td>
          ...
          <!-- /.box -->
                ...
                <div class="box-footer">
                 <div style="width:500px;"><label style="float:left;margin-right:10px;">&nbsp;&nbsp;Net AMount</label><input type="text" name="net_amount" id="net_amount"
				  class="form-control" style="width:155px; float:left; margin-top:-5px;" ></div>
