			 ...
			 <form class="form-horizontal" method="post" action="loginchk.php">
              <div class="box-body" >
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <select class="form-control " name="branch_id" style="width: 100%;" onkeypress="return tabE(this,event)">
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <select class="form-control " name="user_name" style="width: 100%;" onkeypress="return tabE(this,event)">
