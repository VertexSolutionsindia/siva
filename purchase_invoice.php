    ...
    <section class="content container-fluid">
      <div class="row">
        ...
        <div class="col-md-12">
			...
			?>
            <form class="form-horizontal" method="post" action="purchase_invoice_edit_q.php?id=<?php echo $Fct1['id']; ?>">
            ...
            <div class="form-horizontal">
              <div class="box-body">
                 ...
                 <div class="form-group">
                  <label for="phone" class="col-sm-3 control-label">Bar Code</label>
                  <div class="col-sm-9">
				...
				<div class="form-group">
                  <label for="phone" class="col-sm-3 control-label">Qty</label>
                  <div class="col-sm-9">
				...
				<div class="form-group">
                  <label for="phone" class="col-sm-3 control-label">MRP</label>
                  <div class="col-sm-9">
				...
				<div class="form-group">
                  <label for="phone" class="col-sm-3 control-label">Purchase Rate</label>
                  <div class="col-sm-9">
				...
				<div class="form-group">
                  <label for="phone" class="col-sm-3 control-label">Total</label>
                  <div class="col-sm-9">
        ...
        <div class="col-md-12">
            ...
            <div class="box-body" style="overflow:auto">
              ...
              <table id="example1" class="table table-bordered table-striped">
				...
				$s="select * from p_purchase where p_invoice='".$_POST['p_invoice']."' and branch='".$_SESSION['branch']."'";
				$Es=mysql_query($s);
				while($Fs=mysql_fetch_array($Es))
				{
				?>
                <tr>
               
                  <td><?php echo $Fs['barcode']; ?></td>
				  <td><?php echo $Fs['item_name']; ?></td>
				   <td><?php echo $Fs['qty']; ?></td>
				  <td><?php echo $Fs['mrp']; ?></td>
				  <td><?php echo $Fs['discount']; ?></td>
                  <td><?php echo $Fs['prate']; ?></td>
				  <td><?php echo $Fs['total']; ?></td>
                  ...
                  <td>
                    <a href="purchase_order_edit.php?id=<?php echo $Fs['id']; ?>" class="btn-box-tool"><i class="fa fa-edit custom-icon1"></i></a>
