...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-lg"><b>SIVA </b>STORE</span>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
	  ...
	  <span class="style1" style="padding-left:400px"><?php
    ...
    <div class="login-box">
        ...
        <div class="col-md-18">
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
			 <form class="form-horizontal" method="post" action="loginchk.php">
              <div class="box-body" >
			  
			   <div class="form-group">
                  <label for="catcode" class="col-sm-3 control-label">Company</label>
                  <div class="col-sm-8">
                    <select class="form-control " name="company"   style="width: 100%;" onChange="getuser(this.value)" onkeypress="return tabE(this,event)">
				  
				  <?php
				  $sql="select DISTINCT company from m_staff where status='Active'";
                ...
                <div class="form-group">
                  <label for="catcode" class="col-sm-3 control-label">Branch</label>
                  <div class="col-sm-8">
                    <select class="form-control " name="branch_id"   style="width: 100%;" onChange="getuser(this.value)" onkeypress="return tabE(this,event)">
				  
				  <?php
				  $sql="select DISTINCT branch_id from m_staff where status='Active'";
				  $result=mysql_query($sql);
				  while ($row = mysql_fetch_array($result)) {
				...
				<div class="form-group">
                  <label for="catcode" class="col-sm-3 control-label">Username</label>
                  <div class="col-sm-8">
                    <select class="form-control " name="user_name" id="user_list" style="width: 100%;" onkeypress="return tabE(this,event)">
				  
				  <?php
				  $sql="select * from m_staff where status='Active'";
				  $result=mysql_query($sql);
				  while ($row = mysql_fetch_array($result)) {
                ...
                <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="password" class="form-control" name="password" autofocus="autofocus" id="Password" placeholder="Password" onKeyPress="return tabE(this,event)" required>
                      </div>
                    </div>                   
                  
                <button type="submit" onClick="popup_window_show('#popup_window_id_B2562FB5F3577D989E47A6B8FB6A60D4', { pos : 'window-center', parent : this, x : 0, y : 0, width : 'auto' })" class="btn btn-info pull-right">Submit</button>
              </div>
              <!-- /.box-body -->
