      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="box box-info">
            ...
            <form class="form-horizontal" method="post" action="purchase_bill_report_process.php">
            <div class="box-body">
               ...
               <div class="form-group col-sm-4" style="padding-left:60px">
			    ...
			    <div class="form-group col-sm-4" style="padding-left:60px">
                  ...
                  <div>
                 <select class="form-control select2" name="supplier"  style="width: 100%;" onkeypress="return tabE(this,event)">
				  <option>--select supplier Name---</option>
				  <?php
				  $sql="select distinct supplier from p_purchase order by supplier";
              ...
              <!-- /.box-body -->
                ...
                <button class="btn btn-default"> <a href="purchase_bill_report.php">Cancel</a></button>
	   ...
	   <form action="purchase_bill_report_export.php?from=<?php echo $_REQUEST['from']; ?>&to=<?php echo $_REQUEST['to']; ?>&supplier=<?php echo $_REQUEST['supplier'];?>"  method="post" name="export_excel">
        ...
        <div class="col-md-12">
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
				...
				{
				$i=0;
			   $ct="select * from p_purchase where pdate between '".$_REQUEST['from']."' and '".$_REQUEST['to']."' and supplier='".$_REQUEST['supplier']."' and 
                ...
                <tr>
				 ...
				 <td><?php echo $Fct['p_invoice']; ?></td>
				  <td><?php echo $new_date = date('d-m-Y', strtotime($Fct['pdate'])); ?></td>
