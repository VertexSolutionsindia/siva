...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Sales Invoice Report <?php echo $_SESSION['company']; ?>
        <small></small>
      </h1>
    </section>
    ...
    <section class="content container-fluid">
        <form role="form" method="post" action="sales_invoice_report_act.php">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Sales Invoice Report </h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <div class="form-group col-sm-4">
                  <label for="Branch">Sales Invoice No </label>
				  
                  <select class="form-control " name="inv_no" style="width: 100%;" onkeypress="return tabE(this,event)">
				  
				  <?php
				  $sql="select * from t_sales_invoice where company='".$_SESSION['company']."'order by id desc";
				  $result=mysql_query($sql);
				  while ($row = mysql_fetch_array($result)) {
				  
				  ?>
				  <option value="<?php echo $row['inv_no']; ?>"><?php echo $row['inv_no']; ?></option>
				  <?php
				  }
