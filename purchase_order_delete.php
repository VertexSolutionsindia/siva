    ...
    <section class="content container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <h4>Purchase Order Delete<div align="right" style=" border::groove; color:#00BFFF">   </div></h4>
            </div>
			 
            <!-- /.box-header -->
            <div class="box-body" style="overflow:auto">
			
              <table width="83%" class="table table-bordered table-striped" id="example1" style="width:50%">
                <thead>
                <tr>
                  <th width="11%">S:no</th>
                  <th width="24%">Invoice No</th>
				    <th width="20%">Action</th>
                          ...
                          <tbody>
				<?php
				$ct="select DISTINCT p_invoice from p_purchase where  branch='".$_SESSION['branch']."' and status='Active'";
				$Ect=mysql_query($ct);
				$i=0;
		...
		<td><a href="purchase_delete_act.php?p_invoice=<?php echo $Fct['p_invoice']; ?>" onClick="return Delete_Click()" class="btn-box-tool"><i class="fa fa-close custom-icon1"></i></a>
                  </td>
                </tr>
				<?php
				}
