...
<div class="wrapper">
  ...
  onChange="getrate(this.value)">
                ...
                <div class="form-group col-sm-2">
				  ...
				  <div class="form-group col-sm-2">
                  <label for="ponumber">Units</label>
                  <select class="form-control" name="units" id="units"  placeholder="Unit" >
				 <?php
				  $un="select u_name from m_unit_master";
				  $un1=mysql_query($un);
				  while($unit=mysql_fetch_array($un1))
				  {
				  ?>
				  <option value="<?php echo $unit['u_name'];?>"><?php echo $unit['u_name'];?></option>
				  <?php
				  }
				  ?>
				  </select>
