      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="box box-info">
			...
			?>
            <form class="form-horizontal" method="post" action="m_company_creation_master_act.php" enctype="multipart/form-data">
              <div class="box-body">
                  
                <div class="hidden">
                  <label for="code" class="col-sm-3 control-label">Company Id</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="company_id" id="company_id" value="<?php echo $dc; ?>"   required readonly="true"> 
                  </div>
                </div>
				...
				<div class="form-group">
                      <label for="department" class="col-sm-3 control-label">Address</label>
                      <div class="col-sm-8">
                       <input type="text" class="form-control" name="address" id="address" placeholder="Address" onKeyPress="return tabE(this,event)" style="text-transform:uppercase">
                      </div>
                    </div>  
				<div class="form-group">
				...
				<div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="contact_person" id="contact_person"  placeholder="Contact Person" onKeyPress="return tabE(this,event)" style="text-transform:uppercase">
                      </div>
                    </div>  
				<div class="form-group">
				...
				<div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="al_number" id="al_number"  placeholder="Landline Number" onKeyPress="return tabE(this,event)">
                      </div>
                    </div>  
					<div class="form-group">
					...
					<div class="form-group">
                      <label for="altmobno" class="col-sm-3 control-label">Website</label>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="website" id="website"  placeholder="Website" onKeyPress="return tabE(this,event)" style="text-transform:uppercase">
                      </div>
                    </div>                  
                  <div class="form-group">
                      <label for="altmobno" class="col-sm-3 control-label">logo</label>
                      <div class="col-sm-4">
                        <input type="file" class="form-control" name="logo" id="logo"  placeholder="logo" onKeyPress="return tabE(this,event)">
                      </div>
                    </div>  
              </div>
              <!-- /.box-body -->
